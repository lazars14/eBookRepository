...
# Business
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('HUMAN RESOURCES BEST PRACTICES GUIDE', 'Solomon Hill', 'business, money, stock, market, staff', 2010, 1, 2, 4, 0);
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Recruit', 'DAVID SWEET', 'business, money, finance, recruitment, staff', 2007, 1, 2, 5, 0);
...
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Dark Remnants - Street Games: Book One', 'L.K.Hill', 'mistery, crime, darkness, assasination, murder', 2014, 1, 4, 11, 0);
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Handcuffs & High Heels', 'J.M.Edwards', 'mistery, woman, crime, detective, murder', 2014, 1, 4, 12, 0);

Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Attractions', 'Joshua Edward Smith', 'romance, love, drama', 2016, 1, 5, 13, 0);
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Love Letters', 'Bryan Mooney', 'romance, love, woman, complicated, relationship', 2011, 1, 5, 14, 0);
Insert Into eBook(eBook_title, eBook_author, eBook_keywords, eBook_publication_year, eBook_language, eBook_category, eBook_file_id, eBook_deleted) Values ('Pride and Prejudice', 'Jane Austen', 'romance, old, middle age, castle, letter, love', 1813, 1, 5, 15, 0);